...
<body id="index" class="home">
	...
	<header id="banner" class="body">
      ...
      <li class="active"><a href="#">Sociální Sítě</a></li>
		</ul></nav>
	</header>
    ...
    <article class="hentry">	
			<header>
				<h2 class="entry-title"><a href="https://youtube.com/channel/UCrk7AukMNnAgLbxk1o19hcA" rel="bookmark" 
        title=VIP">YouTube</a></h2>
			</header>
    </section>
    ...
    <article class="hentry">	
			<header>
				<h2 class="entry-title"><a href="https://discord.io/DeniskyServer" rel="bookmark" 
        title=VIP">Discord</a></h2>
			</header>
    </section>
    ...
    <article class="hentry">	
			<header>
				<h2 class="entry-title"><a href="https://tiktok.com/@dennyskyserver" rel="bookmark" 
        title=VIP">TikTok</a></h2>
			</header>
    </section>
